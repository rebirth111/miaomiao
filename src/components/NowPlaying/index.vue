<template>
    <div class="movie_body" ref="movie_body">
		<Loading v-if="isLoading" />
	            <Scroller v-else :handleToScroll="handleToScroll" :handleToToScroll="handleToToScroll">
				<ul>
...
export default {
	...
	activated(){
		...
		this.axios.get("/ajax/movieOnInfoList?token="+cityId).then((res)=>{
